...
<nav >
	<ul>
		...
		<li><a href="obirth.php">Back</a></li>
...
<pSuggestions: <div id="txtHint"></div></p>
 ...
 $sql_query="SELECT * FROM birth where 	addressmayor='$idd' && deletee='false'  ";
 ...
 while($row=mysqli_fetch_row($result))
 {
  ...
  <a href="<?php echo "deletdocument.php?id=$row[0]" ?>" 
  >save is done</a>
 ...
 $sql_queryn="SELECT * FROM birth where 	addressmayor='$idd' && deletee='true'  ";
