...
?> 
        ...
        <div class="group">
          ...
          <input id="name" name="name" type="text" class="input" value=<?php echo $name ;
 ?> >
        </div>
        <div class="group">
          <label for="gov" class="label">governorate</label>
          <input id="gov" name="gov" type="text" class="input" value=<?php echo $gov ;?> >
        </div>
        <div class="group">
          <label for="disc" class="label">district</label>
          <input id="disc" name="disc"type="text" class="input" value=<?php echo $disc ;?>>
        </div>
