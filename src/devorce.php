...
function showHint(str)
{
	...
	xmlhttp.open("GET","ajaxfml.php?q="+str,true);
	xmlhttp.send();
}
...
<pSuggestions: <div id="txtHint"></div></p>
 <div id="content">
    <table align="center">
    <tr>
    <th colspan="16"><a href="addppl.php">add data here.</a></th>
    </tr>
    <th>First Name</th>
    <th>Middle Name</th>
    <th>Last Name</th>
...
$idton= $_SESSION['townenter'];
 ...
 $sql_query="SELECT * FROM people WHERE(townid='$idton') && ((gender='female'|| gender='Female')&&(status='married'||status='Married') && (status<>'death' || status <>'Death'))";
 ...
 while($row=mysqli_fetch_row($result))
 {
  ...
  <a href="<?php echo "makedevorce.php?id=$row[0]" ?>" 
  >Make devorce</a>
