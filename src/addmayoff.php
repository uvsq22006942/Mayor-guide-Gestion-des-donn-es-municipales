...
<body>
  ...
  <div class="group" align="right" >
    ...
    <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Add Mayor</label>
    <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab"></label>
    <div class="login-form">
    <form method="post" action="addmayoff.php">
        <div class="group">
...
>
        ...
        <div class="group">
          <label for="lnn" class="label">Last Name</label>
          <input id="lnn" name="lnn"type="text" class="input" >
        </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if (!empty( $us) && !empty( $pass) && !empty( $fn)&& !empty( $ln)&& !empty( $add)&& !empty( $idtown) ){
		$con=mysqli_connect("localhost","root","","guide");

		$query="INSERT INTO mayor VALUES ($id,'$us','$pass','$fn','$ln','$add','$idtown','$rl')";

		if ( mysqli_query($con,$query) ) //run the query
			echo "the user '$us' is succesfuly added";
			
		else
			echo "the user '$us' alreadye exits";
		mysqli_close($con);
