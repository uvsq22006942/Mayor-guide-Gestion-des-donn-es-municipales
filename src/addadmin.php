...
<body>
  ...
  <div class="group" align="right" >
    ...
    <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Add admin</label>
...
>
        ...
        <div class="group">
          <label for="idtown" class="label"> town</label>
          <select name="town" >
  <option >
  <?php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if (!empty( $us)&& !empty( $pass)&&!empty( $fn)&&!empty( $idtown)){
		$con=mysqli_connect("localhost","root","","guide");

		$query="INSERT INTO adminn VALUES ('$id','$us','$pass','$fn','$ln','$idtown','$rl')";
