...
<body>
  ...
  <a style='color:black;' href="mayor.php">Back</a>
    <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Add birth document وثيقة ولادة</label>
    <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab"></label>
    <div class="login-form">
    <form method="post" action="birth.php">
    
        <div class="group">
          <label for="father" class="label">father name    اسم الوالد</label>
          <input id="father" name="father" type="text" class="input" >
        </div>
        <div class="group">
          <label for="bdfather" class="label">Date of birth of the father تاريخ ةلادة الأب </label>
          <input id="bdfather" name="bdfather" type="date" class="input" >
        </div>
        <div class="group">
          <label for="mother" class="label">mother name اسم الأم</label>
          <input id="mother" name="mother" type="text" class="input" >
        </div>
        <div class="group">
          <label for="bdmother" class="label">Date of birthof the mother تاريخ ولادة الأم </label>
          <input id="bdmother" name="bdmother" type="date" class="input" >
        </div>
        <div class="group">
          <label for="newborn" class="label">Name of the newborn اسم المولود</label>
          <input id="newborn" name="newborn" type="text" class="input" >
        </div>
        <div class="group">
          <label for="bd" class="label">Date of birth تاريخ الولادة </label>
          <input id="bd" name="bd" type="date" class="input" >
        </div>
        <div class="group">
          <label for="Registration" class="label">Number of Registration رقم القيد</label>
          <input id="nbreg" name="nbreg" type="number" class="input" >
        </div>
       
    
        <div class="group" >
          <label for="placeb" class="label">Place of birth مكان الولادة</label>
