...
function showHint(str)
{
	...
	xmlhttp.open("GET","ajaxfemalmari.php?q="+str,true);
	xmlhttp.send();
}
...
<pSuggestions: <div id="txtHint"></div></p>
 ...
 $sql_query="SELECT * FROM people where gender='female' && status <>'Married' && status <>'death'|| gender='Female' && status <>'Married' && status <>'death'";
//$sql_query="SELECT * FROM people";
 ...
 while($row=mysqli_fetch_row($result))
 {
  ...
  <a href="<?php echo "Marryher.php?id=$row[0]" ?>" 
  >Marry Her</a>
