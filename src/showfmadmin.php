...
?>
 ...
 <?php      
      ...
      while($row1 = mysqli_fetch_array($result1)) {
        ...
        ?> 
        <tr>
        <td><?php echo  "<p style='color:black;'>".$row1[1]."</p>"; ?></td>
        <td><?php echo "<p style='color:black;'>".$row1[2]."</p>"; ?></td>
        <td><?php echo  "<p style='color:black;'>".$row1[3]."</p>"; ?></td>
        <td><?php echo "<p style='color:black;'>".$row1[4]."</p>"; ?></td>
