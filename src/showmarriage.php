...
<nav >
	<ul>
		...
		<li><a href="omarriage.php">Back</a></li>
...
<pSuggestions: <div id="txtHint"></div></p>
 ...
 $sql_query="SELECT * FROM marriage where 	address='$idd' && deletee='false'  ";
 ...
 while($row=mysqli_fetch_row($result))
 {
  ...
  <a href="<?php echo "deletdocmarr.php?id=$row[0]" ?>" 
  >save is done</a>
 ...
 $sql_queryn="SELECT * FROM marriage where 	address='$idd' && deletee='true'  ";
