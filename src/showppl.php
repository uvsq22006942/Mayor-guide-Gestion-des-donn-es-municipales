...
function showHint(str)
{
	...
	xmlhttp.open("GET","ajaxpplshow.php?q="+str,true);
	xmlhttp.send();
}
...
<pSuggestions: <div id="txtHint"></div></p>
 <div id="content">
    <table align="center">
    <tr>
    <th colspan="15"><a href="addppl.php">add data here.</a></th>
    </tr>
    <th>First Name</th>
    <th>Middle Name</th>
    <th>Last Name</th>
    ...
    <?php
      $_SESSION['townenter']=  $_GET['id'];
        $id = $_SESSION['townenter'];
        
    $con= mysqli_connect("localhost", "root","", "guide");
 $sql_query="SELECT * FROM people where townid='$id'";
