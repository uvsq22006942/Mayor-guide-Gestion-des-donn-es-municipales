...
<body>
  ...
  <div class="group" align="right" >
    ...
    <form method="post" action="updatadmin.php">
<?php 
    $id = $_GET['id'];
...
?> 
        ...
        <div class="group">
          ...
          <input id="username" name="username" type="text" class="input" value=<?php echo $us ;
 ?> >
        </div>
        <div class="group">
          <label for="pass" class="label">Password</label>
          <input id="password" name="password" type="text" class="input" value=<?php echo $pass ;?> >
        </div>
        <div class="group">
        ...
        <div class="group">
          <label for="lt" class="label">Last Name</label>
          <input id="lt" name="lt" type="text" class="input" value=<?php echo $ln ;?>>
        </div>
      
        <div class="group">
          <label for="idtown" class="label">id town</label>
          <input id="idtown" name="idtown" type="text" class="input"value=<?php echo $idtown ;?> >
        </div>
