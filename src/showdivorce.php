...
<nav >
	<ul>
		...
		<li><a href="odivorce.php">Back</a></li>
...
<pSuggestions: <div id="txtHint"></div></p>
 ...
 $sql_query="SELECT * FROM divorce where 	address='$idd' && deletee='false'  ";
 ...
 while($row=mysqli_fetch_row($result))
 {
  ...
  <a href="<?php echo "deletdocdiv.php?id=$row[0]" ?>" 
  >save is done</a>
 ...
 $sql_queryn="SELECT * FROM divorce where 	address='$idd' && deletee='true'  ";
