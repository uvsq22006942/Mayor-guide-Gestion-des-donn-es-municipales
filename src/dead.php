...
function showHint(str)
{
	...
	xmlhttp.open("GET","ajaxppldead.php?q="+str,true);
	xmlhttp.send();
}
...
<pSuggestions: <div id="txtHint"></div></p>
 ...
 $sql_query="SELECT * FROM people WHERE townid='$idton' &&  (status<>'death'||status<>'death')";
 ...
 while($row=mysqli_fetch_row($result))
 {
  ...
  <a href="<?php echo "makedead.php?id=$row[0]" ?>" 
  >Make Death</a>
