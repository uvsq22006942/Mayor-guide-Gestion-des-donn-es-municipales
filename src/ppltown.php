...
function showHint(str)
{
	...
	xmlhttp.open("GET","ajaxppl.php?q="+str,true);
	xmlhttp.send();
}
...
<pSuggestions: <div id="txtHint"></div></p>
 <div id="content">
    <table align="center">
    <tr>
    <th colspan="14"><a href="addppl.php">add data here.</a></th>
    </tr>
    <th>ID Town</th>
    <th>Name Town</th>
    <th>Count of pepole</th>
 
    <th colspan="2">Operations</th>
    </tr>
    <?php
    $con= mysqli_connect("localhost", "root","", "guide");
 $sql_query="SELECT * FROM town ";
 ...
 while($row=mysqli_fetch_row($result))
 {
  ?> 
        ...
        <td><?php 
            ...
            $sqll="select count(*) as total from people where townid='$row[0]'";
  ...
  <a href="<?php echo "showppl.php?id=$row[0]" ?>" 
  >Show People</a>
