...
function showHint(str)
{
	...
	xmlhttp.open("GET","ajaxwomen.php?q="+str,true);
	xmlhttp.send();
}
...
<form> 
Search by number register: <input type="text" onkeyup="showHint(this.value)">
...
<pSuggestions: <div id="txtHint"></div></p>
 ...
 $sql_query="SELECT * FROM people where townid='$town' && gender='female' && status!='death'  ";
