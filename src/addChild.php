...
<a style='color:black;' href="peopleadd.php">Back</a>
<body>

  <div class="login-wrap">
  <div class="login-html">
    <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Add Child</label>
...
<div class="group" background=>
  ...
  $oid=$_GET['id'];
    ...
    $resultat1 = mysqli_query($con,"SELECT * FROM people where id='$oid'");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $fid=$oid;
		...
		$query="INSERT INTO people VALUES ($id,'$fn','$mn','$ln','$mothername','$nbreg','$bd','$add','$placeb','$gender','$status','$religion','$denomination','$district','$governorate','$fid','$mid','$idtown')";
